...
### Para novos Plugins / Scripts:
- [ ] **Ebook & Media Converter:** Um plugin (que faz interface com FFMPEG e Pandoc) atrelado no hub, para facilmente formatar EPUB <> PDF, e comprimir MP4 no menu de contexto do Dolphin usando o kdialog de forma nativa.
